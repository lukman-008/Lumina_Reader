...
// Also fix h.pageIndex to h.pdfPageIndex in makeCustomTextRenderer
content = content.replace(/h\.pageIndex !== undefined && h\.pageIndex !== renderPageIndex/g, 'h.pdfPageIndex !== undefined && h.pdfPageIndex !== renderPageIndex');
