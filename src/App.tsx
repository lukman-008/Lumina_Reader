...
const handleNavigateToResult = useCallback(
  ...
  if (!settings) {
    return (
      <div className="min-h-[100dvh] bg-slate-950 flex items-center justify-center text-slate-400 text-sm">
  ...
  return (
    <div className="min-h-[100dvh] bg-slate-950 flex flex-col font-sans-ui selection:bg-amber-500/30 selection:text-amber-200">
